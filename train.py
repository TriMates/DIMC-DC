...
parser.add_argument("--momentum", type=float, default=0.99,
                    help="momentum")
parser.add_argument("--sd_weight", type=float, default=1e-3,
                    help="soft decorrelation weight")
parser.add_argument("--l2list", type=float, default=1.0,
                    help="l2 distance weight")
